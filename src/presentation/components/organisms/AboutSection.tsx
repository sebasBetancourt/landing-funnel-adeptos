        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative">
              ...
              <div className="absolute top-10 left-0 z-20 w-full pointer-events-none">
                 <h2 className="text-[100px] md:text-[140px] lg:text-[180px] font-brand font-black uppercase text-black leading-[0.8] tracking-tighter">
                    HI, I'M <span className="block">RYAN</span>
                 </h2>
              </div>
              
              {/* Founder Image (Matching the 'Joe' portrait style) */}
              <div className="relative aspect-[3/4] w-full pt-40 md:pt-48">
                 <Image 
                   src={about.image} 
            ...
            <div className="lg:col-span-6 space-y-12 lg:pl-16">
               <div className="space-y-4">
                  <h3 className="text-4xl md:text-5xl font-brand font-black uppercase text-black tracking-tighter leading-none">
                     {about.subHeadline.split('. ')[0]}.
                  </h3>
                  <h3 className="text-4xl md:text-5xl font-brand font-black uppercase text-black tracking-tighter leading-none relative inline-block">
